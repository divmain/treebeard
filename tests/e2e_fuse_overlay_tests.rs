...
fn test_append_to_ignored_file_visible_through_mount() {
    ...
    common::create_test_file(&workspace.repo_path, ".gitignore", "*.ignore\n");
    common::create_test_file(&workspace.repo_path, "example.ignore", "original content\n");
...
fn test_multiple_writes_accumulate_correctly_through_mount() {
    ...
    common::create_test_file(&workspace.repo_path, ".gitignore", "*.log\n");
    common::create_test_file(&workspace.repo_path, "test.log", "line1\n");
...
fn test_truncate_and_write_updates_size_through_mount() {
    ...
    common::create_test_file(&workspace.repo_path, ".gitignore", "*.dat\n");
...
fn test_mount_read_consistency_with_worktree() {
    ...
    common::create_test_file(&workspace.repo_path, ".gitignore", "*.tmp\n");
    common::create_test_file(&workspace.repo_path, "cache.tmp", "initial\n");
